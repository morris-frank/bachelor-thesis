...
class VGG16(object):
    ...
    def base_net(self):
        ...
        self.n.conv1_1, self.n.relu1_1 = conv_relu(self.n.data, 64, pad=100,
                                                   lrmult=0)
        self.n.conv1_2, self.n.relu1_2 = conv_relu(self.n.relu1_1, 64, lrmult=0)
    ...
    def data(self):
        if self.params['split'] == 'train' or self.params['split'] == 'val':
            ...
            transform_param=dict(
                crop_size=224,
                mirror=True,
                mean_value=list(self.params['mean'])
                )
            )
        else:
    ...
    def tail(self):
        ...
        self.n.drop6 = L.Dropout(self.n.relu6, dropout_ratio=0.5, in_place=True)

        fc7, self.n.relu7 = fc(self.n.drop6, std=0.05, lrmult=1)
        self.n.drop7 = L.Dropout(self.n.relu7, dropout_ratio=0.5, in_place=True)
        ...
        self.n.fc8_, _ = fc(self.n.drop7, nout=self.nclasses, std=0.01, lrmult=10)
...
class FCN32s(VGG16):
    ...
    def tail(self):
        ...
        self.n.score_fr_ = L.Convolution(self.n.drop7, num_output=self.nclasses,
                                         kernel_size=1, pad=0,
