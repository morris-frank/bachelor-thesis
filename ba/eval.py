...
def evalYAML(predf, gtf, images):
    ...
    results = {}
    ext = ba.utils.prevalentExtension(images)
    print('Evaluating {}'.format(predf))
    for idx, pred in tqdm(preds.items()):
        rect = pred['region']
        score = pred['score']
        im = imread('{}{}.{}'.format(images, idx, ext))
